...
# 显示帮助信息
show_help() {
    echo -e "${CYAN}悦社动态社区 Docker 部署脚本${NC}"
...
seed_database() {
    ...
    # 检查后端容器是否运行
    if ! docker-compose ps | grep -q "yuecommunity-backend.*Up"; then
